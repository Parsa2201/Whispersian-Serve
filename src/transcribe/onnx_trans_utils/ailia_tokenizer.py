...
def get_tokenizer(multilingual: bool,
    ...
    tokenizer.build_tokenizer('src/transcribe/onnx_trans_utils/assets/multilingual/vocab.json', 'src/transcribe/onnx_trans_utils/assets/multilingual/merges.txt',tokenizer_name, task, language, num_languages)
    return tokenizer
